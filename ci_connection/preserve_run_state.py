...
def parse_cli_args() -> argparse.Namespace:
  parser = argparse.ArgumentParser(
    description=(
      "Preserve the current execution state of a shell script. "
  ...
  parser.add_argument(
    ...
    required=False,
    help=(
      "A command which should be saved as the last one executed, "
  ...
  parser.add_argument(
    ...
    dest="execution_dir",
    help=(
      "Directory at the time of command execution.\n"
  ...
  parser.add_argument(
    ...
    default=True,
    help=(
      "Save the environment variables, and their values.\n"
  ...
  parser.add_argument(
    ...
    help=(
      "A comma-separated list of environment variables to explicitly allow.\n"
...
def save_setup_python_installed_python_env() -> str | None:
  ...
  out_str = "\n".join(f"{k}={v!r}" for k, v in env_vars)
